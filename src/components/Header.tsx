...
// import { Menu, X, Stethoscope, Activity, Heart, Zap } from 'lucide-react';
...
//     { name: 'ECG', path: '/ecg', icon: Heart },
//     { name: 'X-Ray', path: '/xray', icon: Zap },
...
//               className="w-10 h-10 bg-gradient-to-br from-[#1E8449] to-[#2980B9] rounded-lg flex items-center justify-center shadow-lg"
//             >
//               <Stethoscope className="w-6 h-6 text-white" />
//             </motion.div>
//             <motion.span 
//               className="text-xl lg:text-2xl font-bold text-[#34495E] group-hover:text-[#1E8449] transition-colors duration-300"
//             >
//               Q Path Diagnostics
//             </motion.span>
//           </Link>
